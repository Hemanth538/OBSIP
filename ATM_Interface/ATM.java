...
public class ATM extends JFrame {
	...
	boolean readyToEnter2 = false;
	boolean readyToEnter3 = false;
	...
	protected void buildApp(){
		...
		bPConst.weightx= 0.1;
		bPConst.weighty= 0.1;
		JButton transHist = new JButton("Transaction History");
		bPConst.gridx = 0;
		bPConst.gridy = 0;	
		bPConst.insets = new Insets(0, 0, 5, 5);
		transHist.setSize(new Dimension(200, 30));
		buttonPanel.add(transHist, bPConst);
		JButton transfer = new JButton("Transfer");
		bPConst.gridx = 0;
		bPConst.gridy = 1;
		transfer.setSize(new Dimension(200, 30));
		buttonPanel.add(transfer, bPConst);
		...
		transHist.addActionListener(new ActionListener(){
		...
		deposit.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
					displayArea.setText("<html> Deposit Selected! <br> Please input an amout below or equal to \u20B91000 and click enter! <br>Current balance: \u20B9"+ balance+"<br></html>" );
					readyToEnter = true;
			}	
		});
		...
		enter.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(readyToEnter == true){
					...
					inputDisplay.setText("Input Display: ");
					readyToEnter = false;
				} else if(readyToEnter2 == true){
					if(Integer.parseInt(getInputSequence()) > balance){
						displayArea.setText("That input is greater than "+balance);
						clearInput();
						inputDisplay.setText("Input Display: ");
						readyToEnter2 = false;
					} else if(Integer.parseInt(getInputSequence()) == 0 || getInputSequence().equals("0000")){
						...
						updateBalance2(Integer.parseInt(getInputSequence()));
					...
					readyToEnter2 = false;
						...
						if(Integer.parseInt(getInputSequence()) > balance){
							...
							updateBalance2(Integer.parseInt(getInputSequence()));
							displayArea.setText("<html> You have Transferred \u20B9" + getInputSequence() + "! <br><br>" + finishedTransaction() + "</html>");
							System.out.println("User Has transferred \u20B9" + getInputSequence());
							updateTransactionHist("User Has transferred \u20B9" + getInputSequence());
						}
						clearInput();
						inputDisplay.setText("Input Display: ");
						readyToEnter3 = false;
		...
		withDraw.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
					displayArea.setText("<html> withdraw Selected! <br> Please input an amout below or equal to balance and click enter! <br>Current balance: \u20B9"+ balance+" <br></html>" );
					readyToEnter2 = true;
			}	
		});
		...
		transfer.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				displayArea.setText("<html> Transfer Selected! <br> Please enter the amount you want to transfer <br> Current balance: \u20B9"+ balance+" <br></html>" );
